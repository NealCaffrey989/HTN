...
public class TaskAtom extends CompileTimeObject
{
  ...
  */
  ...
  /** the priority of this task atom. If the priority is 1, the task has the 
   * highest priority to be executed;
   */
   private Term priority; 
   
   
   /** the indexOfTask represent the key for it; 
    * 
    */
  ...
  */
  public TaskAtom(Predicate headIn, boolean immediateIn, boolean primitiveIn, Term priorityIn)
  {
    head = headIn;
  ...
  */
  ...
  {
    return new TaskAtom(head.applySubstitution(binding), immediate, primitive, priority);
  }
  ...
  */
  ...
  /** get the priority of this task atom.
   * the priority of the task atom is a number;
   */
 public int getPriority()
 {
     TermNumber p=(TermNumber)priority;
     int p1=(int)p.getNumber();
	 return p1;
 }
  
 //-- check whether two task atoms is equal;
 public boolean equals(Object obj)
 {
	 if ((obj instanceof TaskAtom)
	     &&(head.equals(((TaskAtom)obj).getHead()))
	     &&(immediate == ((TaskAtom)obj).isImmediate())
		 &&(primitive == ((TaskAtom)obj).isPrimitive())
		 &&(((TermNumber)(this.priority)).getNumber() ==(((TaskAtom)obj).getPriority()))
		 &&(indexOfTask == ((TaskAtom)obj).indexOfTask)
		 )
	     return true;
	 else
	     return false;
  ...
  */
  public String toCode()
  {
    return "new TaskAtom(" + head.toCode() + ", " + immediate + ", " +
           primitive + ", "+ ((TermNumber)priority).toCode() + ")";
  }
