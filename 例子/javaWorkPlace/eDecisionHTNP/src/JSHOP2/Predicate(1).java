...
public class Predicate extends CompileTimeObject
{
  ...
  */
  public boolean equalParams(Term t)
  {
    if (isVar())
      return false;
  ...
  /**whether or not the input predicate is equal to this predicate;
   * @param tpIn
   */
  public boolean equals(Object obj)
  {

	    if((obj instanceof Predicate)&&(head == ((Predicate)obj).getHead())&&
	    	(varCount == ((Predicate)obj).getVarCount())&&
	        (param.equals(((Predicate)obj).getParam()))&&(varIdx == ((Predicate)obj).getVarIdx()))
	      return true;
	    else  
	      return false;
  }
