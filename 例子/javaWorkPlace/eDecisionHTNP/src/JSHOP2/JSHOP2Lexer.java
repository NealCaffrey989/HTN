...
public JSHOP2Lexer(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("imply", this), new Integer(32));
	literals.put(new ANTLRHashString("start", this), new Integer(22));
	literals.put(new ANTLRHashString("nil", this), new Integer(8));
	literals.put(new ANTLRHashString("TR", this), new Integer(21));
	literals.put(new ANTLRHashString("call", this), new Integer(34));
	literals.put(new ANTLRHashString("member", this), new Integer(40));
	literals.put(new ANTLRHashString("stdlib", this), new Integer(46));
	literals.put(new ANTLRHashString("end", this), new Integer(24));
	literals.put(new ANTLRHashString("def-problem-set", this), new Integer(45));
	...
	literals.put(new ANTLRHashString("and", this), new Integer(29));
}
