...
public abstract class DelAddElement extends CompileTimeObject
{
  ...
  */
  public abstract void addInstantEffects(State s, Term[] binding, Vector[] delAddList);
  ...
  */
  public abstract boolean delInstantEffects(State s, Term[]binding, Vector[] delAddList);
  ...
  */
  ...
  /** This function produces Java code to create this delete/add
   *  element.
  */
