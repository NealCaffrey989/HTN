...
public class MainJSHOP2 
{
	...
	{
		//problem.getPlans();
		//WriteXMLtoDisk("E:/³ÌÐò/Java/jshop2/src/JSHOP2/doc/jshopresult.xml");		
		
		String domain="ProjectRescue";
	...
	private static void comple(String[] args,String domain)
	{
		if (args.length==2&& args[0].equals("-r")) 
		 {
			 String[] s={"-r"+args[1].toString(),"E:/javaWorkPlace/shop2/src/problem"};
			 InternalDomain.Comples(s);
		 }
		 else if(args[0].equals("-ra"))
		 {
			 String[] s={"-ra","E:/javaWorkPlace/shop2/src/problem"};
			 InternalDomain.Comples(s);
		 }
		 else if(!args[0].contains("-r"))
		 {
			 String[] s1={"E:/javaWorkPlace/shop2/src/"+domain};
			 InternalDomain.Comples(s1);
		 }
		 else
		 {
			 String[] s={"-r","E:/javaWorkPlace/shop2/src/problem"};
			 InternalDomain.Comples(s);
		 }		
	}
	...
	{
		File f = null;
		File mydir=new File("E://³ÌÐò//Java//jshop2//src//JSHOP2//bin");
